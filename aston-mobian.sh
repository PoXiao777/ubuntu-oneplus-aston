...
ls rootdir/etc/
chroot rootdir cat /etc/resolv.conf
chroot rootdir echo "nameserver 1.1.1.1" > rootdir/etc/resolv.conf
chroot rootdir cat /etc/resolv.conf
chroot rootdir echo "oneplus-aston" | tee rootdir/etc/hostname
chroot rootdir echo "127.0.0.1 localhost
